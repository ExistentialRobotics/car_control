...
void DDControlNode::publishDDCommand(void)
{
  if (!have_odom_)
  {
...
void DDControlNode::position_cmd_callback(const geometry_msgs::PoseStamped::ConstPtr &cmd)
{
...
void DDControlNode::odom_callback(const nav_msgs::Odometry::ConstPtr &odom)
{
  have_odom_ = true;
...
void DDControlNode::onInit(void) {
  ros::NodeHandle n("~");
  std::string robot_name;
  // Setup Subscribers
  odom_sub_ = n.subscribe("odom", 10, &DDControlNode::odom_callback, this, ros::TransportHints().tcpNoDelay());
  position_cmd_sub_ = n.subscribe("position_cmd", 10, &DDControlNode::position_cmd_callback, this,
